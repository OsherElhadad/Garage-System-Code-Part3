...
{
    public partial class UpdateGarage : Form
    {
        public UpdateGarage()
        {
            InitializeComponent();
        ...
        {
            if (label13.Text == "תקין" && label14.Text == "תקין" && label15.Text == "תקין" && label16.Text == "תקין" && label17.Text == "תקין" && label18.Text == "תקין" && label19.Text == "תקין" && label20.Text == "תקין" && label21.Text == "תקין" && label22.Text == "תקין" && label24.Text == "תקין")
            {
                string sql = "SELECT * FROM Cities WHERE Name='" + textBox3.Text + "'";
                DataTable dt = MyAdoHelperCsharp.ExecuteDataTable("Database1.mdf", sql);
                string sql1 = "SELECT * FROM PreTelephone WHERE Pre='" + comboBox2.Text + "'";
                DataTable dt1 = MyAdoHelperCsharp.ExecuteDataTable("Database1.mdf", sql1);
                string sql2 = "SELECT * FROM PrePhone WHERE Pre='" + comboBox3.Text + "'";
                DataTable dt2 = MyAdoHelperCsharp.ExecuteDataTable("Database1.mdf", sql2);
                string update = "UPDATE Garages SET GarageName='" + textBox10.Text + "', ContactFName='" + textBox1.Text + "', ContactLName='" + textBox2.Text + "', GarageCity='" + dt.Rows[0]["ID"].ToString() + "', GarageStreet='" + textBox4.Text + "', GarageHNumber='" + textBox5.Text + "', GarageZipCode='" + textBox6.Text + "', GaragePreTelephone='" + dt1.Rows[0]["Number"].ToString() + "', GarageTelephone='" + textBox7.Text + "', ContactPrePhone='" + dt2.Rows[0]["Number"].ToString() + "', ContactPhone='" + textBox8.Text + "', GarageEmail='" + textBox9.Text + "', Discount='" + textBox12.Text + "', Active='" + checkBox1.Checked + "' WHERE GarageNumber='" + ID + "'";
                MyAdoHelperCsharp.DoQuery("Database1.mdf", update);
                MessageBox.Show("מוסך עודכן בהצלחה");
            }
            else
        ...
        private void textBox10_TextChanged(object sender, EventArgs e)
        {
            if (!Checks.NameLength(textBox10.Text, 4) || !Checks.NameSofiot(textBox10.Text))
            {
                ...
                label13.Text = "שם מוסך זה לא תקין";
            }
            else
            {
        ...
        {
            if (!string.IsNullOrEmpty(textBox5.Text) && MyAdoHelperCsharp.IsExist("Database1.mdf", "SELECT * FROM Garages WHERE GarageCity='" + Checks.GetCityNum(textBox3.Text) + "' AND GarageStreet='" + textBox4.Text + "' AND GarageHNumber !='" + textBox5.Text + "'"))
            {
                DataTable dt = MyAdoHelperCsharp.ExecuteDataTable("Database1.mdf", "SELECT GarageHnumber, GarageZipCode FROM Garages WHERE GarageCity='" + Checks.GetCityNum(textBox3.Text) + "' AND GarageStreet='" + textBox4.Text + "' AND GarageHNumber !='" + textBox5.Text + "'");
            ...
            {
                if (MyAdoHelperCsharp.IsExist("Database1.mdf", "SELECT * FROM Garages WHERE GarageCity='" + Checks.GetCityNum(textBox3.Text) + "' AND GarageStreet='" + textBox4.Text + "' AND GarageHNumber ='" + textBox5.Text + "'"))
                {
                    DataTable dt = MyAdoHelperCsharp.ExecuteDataTable("Database1.mdf", "SELECT GarageHnumber, GarageZipCode FROM Garages WHERE GarageCity='" + Checks.GetCityNum(textBox3.Text) + "' AND GarageStreet='" + textBox4.Text + "' AND GarageHNumber ='" + textBox5.Text + "'");
                    textBox6.Text = dt.Rows[0]["GarageZipCode"].ToString();
